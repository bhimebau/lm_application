...
/*! \mainpage uEAC Hybrid Computer Operating System  
    ...
    \section B uEAC R002 Schematics and Board Fabrication Files 
    <ul> 
        ...
        <li> <a href="../pdf/ueac_bom.pdf"> Bill of Materials </a>
        <li> <a href="IUCS_uEAC_R002_b.zip"> Board Design Files </a>
        <li> <a href="ueac_plexi.zip"> Laser Cut Plastic Design Files (TurboCAD)</a>
